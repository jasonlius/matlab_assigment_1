...
% figure;
% plot(xy_approx_3_sigma_Nonlinear(1,:), xy_approx_3_sigma_Nonlinear(2,:),"Color","black","LineWidth",2)
% axis equal
% hold on 
% plot(Gaussian_approx_Nonlinear(1,:), Gaussian_approx_Nonlinear(2,:),'.',"Color","red","LineWidth",2)
% axis equal
